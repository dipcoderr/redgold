...
function Register() {
    ...
    const registerHelper = (e) => {
        ...
        fetch('http://localhost:5000/api/auth/register', fetchData)
        .then(res => res.json())
        .then(data2 => {
            setLoading(false);
            if(data2.error) {
                        ...
                        <>
                            ...
                            <form onSubmit={(e) => registerHelper(e)}>
                                <div className="form-group">
                                    <input type="text" className="form-control" id="name" aria-describedby="nameHelp" autoFocus placeholder="Name (e.g. Dipanshu Mishra)" onChange={(e) => setName(e.target.value)} required />
                                </div>
                                <br />
                                <div className="form-group">
                            ...
                            <p className="text-center">
                                <Link to="/admin-register" style={{ textDecoration: 'none', color: '#dc3545' }}>

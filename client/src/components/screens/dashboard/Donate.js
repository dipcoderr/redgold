...
function Donate() {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:5000/api/appointment/all', {
            method: "get",
            headers: {
    ...
    const deleteAppointment = (appointmentId) => {
        ...
        fetch(`http://localhost:5000/api/appointment/delete/${appointmentId}`, fetchData)
        .then(res => res.json())
        .then(data2 => {
            if(data2.error) {
    ...
    const donateBlood = () => {
        ...
        fetch('http://localhost:5000/api/appointment/new', fetchData)
        .then(res => res.json())
        .then(data2 => {
            if(data2.error) {
                toast.error(data2.error)
